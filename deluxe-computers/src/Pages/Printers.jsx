...
export default function Printers() {
  const products = [
    { name: "Printer 1", price: "Ksh 75,000", img: "https://via.placeholder.com/200" },
    { name: "Printer 2", price: "Ksh 82,000", img: "https://via.placeholder.com/200" },
    { name: "Printer 3", price: "Ksh 82,000", img: "https://via.placeholder.com/200" },
    { name: "Printer 4", price: "Ksh 82,000", img: "https://via.placeholder.com/200" },
    { name: "Printer 5", price: "Ksh 82,000", img: "https://via.placeholder.com/200" },
    { name: "Printer 6", price: "Ksh 82,000", img: "https://via.placeholder.com/200" },
  ];
