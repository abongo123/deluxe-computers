...
export default function Mice() {
  ...
  const products = [
    { name: "Mouse2", price: 1200, img: "https://via.placeholder.com/200" },
    { name: "Mouse3", price: 1700, img: "https://via.placeholder.com/200" },
    { name: "Mouse4", price: 2500, img: "https://via.placeholder.com/200" },
    { name: "Mouse5", price: 3200, img: "https://via.placeholder.com/200" },
    { name: "Mouse6", price: 3000, img: "https://via.placeholder.com/200" },
    { name: "Mouse7", price: 4000, img: "https://via.placeholder.com/200" },
  ];
