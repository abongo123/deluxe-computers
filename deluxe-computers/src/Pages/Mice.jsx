...
export default function Mice() {
  const products = [
    { name: "Mouse A", price: "Ksh 75,000", img: "https://via.placeholder.com/200" },
    { name: "Mouse B", price: "Ksh 82,000", img: "https://via.placeholder.com/200" },
    { name: "Mouse C", price: "Ksh 150,000", img: "https://via.placeholder.com/200" },
    { name: "Mouse D", price: "Ksh 75,000", img: "https://via.placeholder.com/200" },
  ];
