...
export default function Toners() {
  ...
  const products = [
    { name: "Toner2", price: 1200, img: "https://via.placeholder.com/200" },
    { name: "Toner3", price: 1700, img: "https://via.placeholder.com/200" },
    { name: "Toner4", price: 2500, img: "https://via.placeholder.com/200" },
    { name: "Toner5", price: 3200, img: "https://via.placeholder.com/200" },
    { name: "Toner6", price: 3000, img: "https://via.placeholder.com/200" },
    { name: "Toner7", price: 4000, img: "https://via.placeholder.com/200" },
  ];
