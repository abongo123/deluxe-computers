...
export default function Toners() {
  const products = [
    { name: "Toner A", price: "Ksh 75,000", img: "https://via.placeholder.com/200" },
    { name: "Toner B", price: "Ksh 82,000", img: "https://via.placeholder.com/200" },
    { name: "Toner C", price: "Ksh 150,000", img: "https://via.placeholder.com/200" },
    { name: "Toner D", price: "Ksh 75,000", img: "https://via.placeholder.com/200" },
    { name: "Toner E", price: "Ksh 82,000", img: "https://via.placeholder.com/200" },
    { name: "Toner F", price: "Ksh 75,000", img: "https://via.placeholder.com/200" },
    { name: "Toner G", price: "Ksh 82,000", img: "https://via.placeholder.com/200" },
  ];

  return (
    <div className="flex p-12 gap-8">
      <div className="w-1/8 p-6 rounded-none space-y-4 text-start border-r border-gray-400">
        <h2 className="text-xl font-semibold border-b">Filter</h2>
