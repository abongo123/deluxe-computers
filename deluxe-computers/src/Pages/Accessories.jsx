...
export default function Accessories() {
  ...
  const products = [
    { name: "Acc1", price: 1200, img: "https://via.placeholder.com/200" },
    { name: "Acc3", price: 1700, img: "https://via.placeholder.com/200" },
    { name: "Acc4", price: 2500, img: "https://via.placeholder.com/200" },
    { name: "Acc5", price: 3200, img: "https://via.placeholder.com/200" },
    { name: "Acc6", price: 3000, img: "https://via.placeholder.com/200" },
    { name: "Acc7", price: 4000, img: "https://via.placeholder.com/200" },
  ];
