...
export default function Accessories() {
  ...
  const products = [
    { name: "ACC2", price: 75000, img: "https://via.placeholder.com/200" },
    { name: "ACC3", price: 82000, img: "https://via.placeholder.com/200" },
    { name: "ACC4", price: 150000, img: "https://via.placeholder.com/200" },
    { name: "ACC5", price: 150000, img: "https://via.placeholder.com/200" },
    { name: "ACC6", price: 150000, img: "https://via.placeholder.com/200" },
    { name: "ACC2", price: 150000, img: "https://via.placeholder.com/200" },
  ];
