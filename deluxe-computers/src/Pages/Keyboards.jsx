...
export default function Keyboards() {
  const products = [
    { name: "Keyboard A", price: "Ksh 75,000", img: "https://via.placeholder.com/200" },
    { name: "Keyboard B", price: "Ksh 82,000", img: "https://via.placeholder.com/200" },
    { name: "Keyboard C", price: "Ksh 150,000", img: "https://via.placeholder.com/200" },
    { name: "Keyboard D", price: "Ksh 75,000", img: "https://via.placeholder.com/200" },
  ];
