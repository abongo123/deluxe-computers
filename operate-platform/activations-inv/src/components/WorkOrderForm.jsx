...
const OUTCOMES = ["Pending", "Completed", "Failed", "N/A"];
...
export default function WorkOrderForm({ onClose, onSave, initial = {} }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/30 flex items-start justify-center p-6">
      <form className="bg-white rounded-lg shadow p-6 w-full max-w-2xl" onSubmit={handleSubmit}>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <label className="block">
            <div className="text-xs text-gray-600">Day 1 Outcome</div>
          ...
          <label className="block">
            <div className="text-xs text-gray-600">Day 2 Outcome</div>
